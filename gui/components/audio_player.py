...
class AudioWaveformWidget(QWidget):
    """Widget for displaying and controlling audio playback with waveform visualization."""
    ...
    def load_audio(self, audio_path):
        """Loads and visualizes an audio file."""
    ...
    def toggle_playback(self):
        """Toggles play/pause for the audio file."""
    ...
    def update_play_button(self, state):
        """Updates the play button icon based on playback state."""
    ...
    def set_position(self, position):
        """Sets the audio position based on slider movement."""
    ...
    def update_position(self, position):
        """Updates the UI based on the current playback position."""
        if self.player.duration() > 0:
    ...
    def update_duration(self, duration):
        """Updates the UI when the audio duration is known."""
        self.position_slider.setRange(0, 100)
